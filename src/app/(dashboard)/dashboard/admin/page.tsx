...
export default function AdminDashboardPage() {
  const { organization, users, projects, tickets } = useAuth();
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold text-white tracking-tight font-sf-display">{organization.name} Organization Admin Dashboard</h1>
          ...
          <Card className="border-l-4 border-l-navy-900">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-black text-navy-950 mt-1 font-sf-display">{totalProjects}</h3>
              </div>
          ...
          <Card className="border-l-4 border-l-blue-600">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-black text-blue-700 mt-1 font-sf-display">{totalDevelopers}</h3>
              </div>
          ...
          <Card className="border-l-4 border-l-rose-600">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-black text-rose-700 mt-1 font-sf-display">{criticalBugs}</h3>
              </div>
          ...
          <Card className="border-l-4 border-l-emerald-600">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-black text-emerald-700 mt-1 font-sf-display">{resolvedThisWeek}</h3>
              </div>
                ...
                return (
                  <div key={dev.id} className="p-3 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-between shadow-apple-sm">
                    <div className="flex items-center gap-3">
                      <Avatar name={dev.full_name} size="sm" />
                      <div>
              ...
              {Object.entries(STATUS_LABELS).slice(0, 8).map(([statusKey, label]) => {
                ...
                return (
                  <div key={statusKey} className="p-3 bg-slate-50 border border-slate-200 rounded-2xl space-y-1 shadow-apple-sm">
                    ...
                    <p className="text-xl font-black text-navy-950 font-sf-display">{count}</p>
                  </div>
                );
              })}
            </div>
