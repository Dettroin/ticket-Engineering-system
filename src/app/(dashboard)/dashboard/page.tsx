...
export default function DashboardRouterPage() {
  ...
  // Determine current active dashboard view based on active tab override or user role
  const currentRoleView: UserRole = (activeTab as UserRole) || user.role;
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-2.5 shadow-apple-sm flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 px-2">
          ...
          <span className="text-xs font-bold text-navy-950">Active Role Dashboard:</span>
            ...
            const isSelected =
              ...
              (!activeTab &&
                (user.role === tab.role ||
                  ...
                  (tab.role === 'frontend_developer' && ['developer', 'frontend_developer', 'backend_developer', 'team_lead'].includes(user.role))));
